...
const plans = [
  {
    name: "Free",
    price: "Gratis",
    description: "Cocok untuk pengguna baru yang mau coba dulu",
    icon: Zap,
    features: [
      "Upload foto produk (maks 5 foto/hari)",
      "Generate poster sederhana (template dasar)",
      "Generate caption singkat (1 versi)",
      "Simpan 3 hasil poster",
      "AI Photo Enhancer versi basic",
    ],
    highlighted: false,
  ...
  },
  {
    ...
    price: "Rp 99k",
    period: "/bulan",
    description: "Cocok untuk UMKM yang mulai aktif promosi",
    icon: Sparkles,
    features: [
      "Semua fitur Free",
      "Upload foto tanpa batas harian",
      "AI Poster Generator template premium",
      "AI Caption Generator (3-5 versi)",
      "AI Photo Enhancer Pro",
      "Download file HD",
      "Simpan unlimited poster",
  ...
  },
  {
    ...
    price: "Rp 249k",
    period: "/bulan",
    description: "Cocok untuk UMKM besar atau agensi kecil",
    icon: Crown,
    features: [
      "Semua fitur Basic",
      "AI Poster Generator custom prompt",
      "Scene Generate: studio virtual",
      "Batch Upload (upload banyak sekaligus)",
      "AI Marketing Analyzer",
      "Generate 10+ varian caption",
      "Watermark remover",
      "Akses prioritas AI tercepat",
